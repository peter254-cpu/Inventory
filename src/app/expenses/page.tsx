...
const Expenses = () => {
        ...
        const filtered: AggregatedData = expenses.filter(
            ...
            if (!acc[data.category]) {
                ...
                acc[data.category].color = `
                    #${Math.floor(Math.random() * 1677725).toString(16)}
                `
    ...
    const classNames = {
        ...
        select: "mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md bg-white"
    }
        ...
        <div>
            <div className='mb-5'>
                ...
                <p className='text-sm text-gray-500'>
                    Visual Representation Of Our Operational Cost Over Time
                </p>
            </div>
