...
import { Archive, CircleDollarSign, Clipboard, Layout, LucideIcon, Menu, Moon, SlidersHorizontal, Sun, User } from "lucide-react";
...
const Sidebar = () => {
  ...
  const sidebarClassNames = `flex flex-col justify-between ${isSidebarCollapsed ? "w-16 md:w-16" : "w-72 md:w-64"} bg-white transition-all duration-300 overflow-hidden  shadow-md z-40`;
  ...
  return (
    <div className={sidebarClassNames}>
      ...
      <div className="flex-grow mt-8">
        ...
        <div onClick={toggleDarkMode} className={`cursor-pointer flex items-center ${isSidebarCollapsed ? "justify-center py-4" : "justify-start px-8 py-4"} hover:text-blue-500 hover:bg-blue-100 gap-3`}>
          {isDarkMode ? (
            <div className="flex gap-3">
              <Sun className="w-6 h-6 !text-gray-700" size={24} />
              <span
            ...
            <div className="flex gap-3">
              ...
              <span className={`${isSidebarCollapsed ? "hidden" : "block"} font-medium text-gray-700`}
              >
                Dark theme
              </span>
            </div>
